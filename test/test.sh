...
curl -H "Content-Type: applicaton/json" -d '{"foods": [{"name": "豆腐","price": 10,"food_type": "素食","description": "美味","image": "/image/doufu.png","available": "True","restaurant_id": 9527}]}' http://localhost:5000/restaurants/9527/menu -X POST --cookie cookie_file.txt
